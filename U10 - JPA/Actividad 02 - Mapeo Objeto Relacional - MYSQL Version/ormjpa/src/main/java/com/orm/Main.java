...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            tipoMoneda.setFechaBaja(LocalDateTime.now());
            ...
            condicionIva.setFechaBaja(LocalDateTime.now());
            ...
            puntoVenta.setFechaBaja(LocalDateTime.now());
            ...
            listaPrecio.setFechaBaja(LocalDateTime.now());
            ...
            listaPrecioArticulo.setFechaBaja(LocalDateTime.now());
            ...
            facturaVenta.setFechaBaja(LocalDateTime.now());
            ...
            detalle1.setImporteNeto(300.00);
            ...
            // Persistir solo la FacturaVenta (cascada persiste automáticamente los
            // detalles)
